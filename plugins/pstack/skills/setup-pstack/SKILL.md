...
arena runners: claude:fable@max, codex:gpt-5.6-sol@max, cursor:cursor-grok-4.6-xhigh@xhigh, claude:opus@xhigh
arena cross-judge pool: claude:fable@max, codex:gpt-5.6-sol@max, cursor:cursor-grok-4.6-xhigh@xhigh, claude:opus@xhigh
swarm workers: cursor:cursor-grok-4.6-xhigh@xhigh
architect runners: claude:fable@max, codex:gpt-5.6-sol@max, cursor:cursor-grok-4.6-xhigh@xhigh, claude:opus@xhigh
interrogate reviewers: claude:fable@max, codex:gpt-5.6-sol@max, cursor:cursor-grok-4.6-xhigh@xhigh, claude:opus@xhigh
```
