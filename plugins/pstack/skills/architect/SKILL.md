...
Use your configured architect runners (defaults `claude:claude-fable-5@max`, `codex:gpt-5.6-sol@max`, `cursor:cursor-grok-4.6-xhigh@xhigh`, `claude:claude-opus-5@xhigh`).
